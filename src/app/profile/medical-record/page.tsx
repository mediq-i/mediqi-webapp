...
function MedicalRecordPage() {
    return (
        <div className='p-6'>
            ...
            <p className='text-sm'>View all your past records and notes for convenience and reference</p>
            <div className='my-10'>
                <div className=' border rounded-lg w-[45%] p-3 my-3'>
                    <div className=' flex justify-between'>
                        ...
                        <div>
                        <p className='flex items-center gap-1 text-sm text-[#34C759]'><Check className='h-5'/> Done</p>
                            <p className='flex items-center gap-1 text-sm text-[#98A2B3]'><FileText className='h-5'/> 3 notes</p>
                        </div>
